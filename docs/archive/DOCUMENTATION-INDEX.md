...
- **[docs/ADR-001-generic-runtime-architecture.md](./ADR-001-generic-runtime-architecture.md)**
...
- **[docs/FEATURES-AND-TESTS.md](./FEATURES-AND-TESTS.md)**
...
│   ├── CICD-VERIFICATION-COMPLETE.md      ← CI/CD verification
│   ├── GITHUB-SETUP-GUIDE.md              ← GitHub setup
...
- **Check architecture decisions** → Read [docs/ADR-001-generic-runtime-architecture.md](./ADR-001-generic-runtime-architecture.md)
...
**Related files:**
- Architecture → [docs/ADR-001-generic-runtime-architecture.md](./ADR-001-generic-runtime-architecture.md)
- Features → [docs/FEATURES-AND-TESTS.md](./FEATURES-AND-TESTS.md)
...
2. **Deep Dive (1-2 hours)**
   ...
   - Review [docs/FEATURES-AND-TESTS.md](./FEATURES-AND-TESTS.md)
...
4. **Architecture Deep Dive (1 hour)**
   - Read [docs/ADR-001-generic-runtime-architecture.md](./ADR-001-generic-runtime-architecture.md)
